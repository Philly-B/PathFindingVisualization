...
export const setStart = createAction(SET_START, props<{ newStart: P5Vector }>());
...
export const setEnd = createAction(SET_END, props<{ newEnd: P5Vector }>());
...
export const modifyWalls = createAction(MODIFY_WALLS, props<{ newWalls: P5Vector[] }>());
